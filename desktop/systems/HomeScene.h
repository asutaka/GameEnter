                ...
                if (showing_context_menu) {
                     ...
                     if (mx >= menu_x && mx <= menu_x + menu_w && my >= menu_y && my <= menu_y + menu_h) {
                         ...
                         if (clicked_item == 0) { // Add Shortcut
                             if (create_shortcut(slots[context_menu_slot].name, "")) {
                                 toast_message = "Shortcut Created!";
             ...
             if (showing_context_menu) {
                ...
                for (int i = 0; i < 4; i++) {
                    ...
                    if (i == 0) { // Shortcut
                        ...
                        font_small.draw_text(renderer, "Add InGame Shortcut", text_x, center_y + 6, {34, 43, 50, 255});
